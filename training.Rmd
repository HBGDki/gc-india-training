...
***
**Your Turn:**  View the data for the other data frames that we read in... How many anthro records are there? How many "post" records are there?
...
TODO: Exercise: can we identify who the outlying kids are and what characteristics they have?
...
NOTE: mention that there is no truncation
...
Q: What covariates predict a child that's not going to recover?

TODO: trelliscope display here of raw data?
...
TODO: maybe just pick one or two to illustrate something interesting.
...
Include image y = mx as intro to modeling
...
TODO: break into separate chunks
...
TODO: move covariate analysis to the end
...
TODO: to find the parameters that you can use, see (point to place in docs)
TODO: use different method that's faster
...
TODO: add column: ever stunted and ever wasted, severity of stunting (Shasha will send bins)
