#;;;;;;;;;;;;;;;;;;;;;;;;;MODEL NOTES;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
# HBGD Knowledge Integratiop Group  (BMGF)                                                  ;
# Shasha Jumbe                                                                             ;
...
MonoExpModel = function(lnLinf, lnL0, lnKgr, TIME) {
  ...
  pred = Linf - (Linf - L0)*exp(-Kgr * TIME)
...
NLLDmodel <- function(lnLinf,lnL0, lnKgr0,logitKgrdec,lnTTP50,TIME) {
  ...
  # logitKgrdec = logit of asymptotic fractional reduction in growth deceleration (at large values of TIME)
